...
///
/// [CustomRatingBar] can also be used to display rating
///
...
class CustomRatingBar extends StatefulWidget {
  /// Creates [CustomRatingBar] using the [ratingWidget].
  const CustomRatingBar({
    /// Customizes the Rating Bar item with [RatingWidget].
    required CustomRatingWidget ratingWidget,
    ...
    this.onRatingLessThanMin,
  })  : _itemBuilder = null,
        _ratingWidget = ratingWidget;

  /// Creates [CustomRatingBar] using the [itemBuilder].
  const CustomRatingBar.builder({
  ...
  final VoidCallback? onRatingLessThanMin;
  ...
  /// How the item within the [CustomRatingBar] should be placed in the main axis.
  ///
  ...
  final CustomRatingWidget? _ratingWidget;
...
class _CustomRatingBarState extends State<CustomRatingBar> {
    ...
    return IgnorePointer(
      ...
      child: GestureDetector(
        onTapDown: (details) {
          ...
          if (value < widget.minRating) {
            widget.onRatingLessThanMin?.call();
          }
  ...
  void _onDragUpdate(DragUpdateDetails dragDetails) {
    if (!widget.tapOnlyMode) {
      ...
      if (currentRating < widget.minRating) {
        widget.onRatingLessThanMin?.call();
      }
